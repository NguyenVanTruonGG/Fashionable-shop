			...
			<div class="panel-body">
				<form class="form-horizontal" name="" method="post" enctype="multipart/form-data">
				  <div class="form-group">
				    ...
				    <div class="col-sm-5">
				      <input type="text" name='name' class="form-control" id="inputEmail3" placeholder="Vui lòng nhập tên slider!" value="<?php echo $slider->name; ?>">
				    </div>
				    <div class="col-sm-4">
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-5">
				      <input type="text" name='link' class="form-control" id="inputEmail3" placeholder="Vui lòng nhập liên kết!" value="<?php echo $slider->link; ?>">
				    </div>
				    <div class="col-sm-4">
