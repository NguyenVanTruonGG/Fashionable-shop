            ...
            <div class="panel-body">
                <form class="form-horizontal" name="" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" name='name' class="form-control" id="inputEmail3" placeholder="Vui lòng nhập tên sản phẩm!" value="<?php echo $product->name; ?>">
                        </div>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" name='price' class="form-control" id="inputEmail3" placeholder="Vui lòng nhập giá tiền!" value="<?php echo number_format($product->price); ?>">
                        </div>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" name='discount' class="form-control" id="inputEmail3" placeholder="Vui lòng nhập số giảm giá!" value="<?php echo number_format($product->discount); ?>">
                        </div>
                    </div>
                    <div class="form-group">
